$(document).ready(function () {
  ...
  $("#wrapper").on("click", ".project_link", function (e) {
    ...
    $(this)
      ...
      .find(".project_link.active")
      .removeClass("active");
    var preview_pane = $(this)
      .parents(".project_list")
      .siblings(".preview_pane_container")
      .find(" .preview_pane");
    var info_link = $(this)
      .parents(".project_list")
      .siblings(".preview_pane_container")
      .find(" .info_link");
    // Check if it's an image preview
    if ($(this).attr("data-preview-type") === "image") {
      preview_pane.html(
        '<img src="' +
          $(this).attr("href") +
    ...
    var title_block = $(this)
      ...
      .siblings(".preview_pane_container")
      .find("h4");
    var description_block = $(this)
      .parents(".project_list")
      .siblings(".preview_pane_container")
      .find(".project_description");
    var technologies_block = $(this)
      .parents(".project_list")
      .siblings(".preview_pane_container")
      .find(".technologies_used");
    description_block.html($(this).attr("data-description"));
    title_block.html($(this).attr("data-title"));
    technologies_block.html(
      "<b>Technologies Used:</b> " + $(this).attr("data-technologies")
    );
    info_link.html(
      '<a href="' +
        $(this).attr("data-link") +
  ...
  $(".project_list").each(function () {
    ...
    technologies_block.html(
      "<b>Technologies Used:</b> " + list_item.attr("data-technologies")
    );
    title_block.html(list_item.attr("data-title"));
    info_link.html(
      '<a href="' +
        list_item.attr("data-link") +
        '">' +
        list_item.attr("data-link") +
        "</a>"
    );
